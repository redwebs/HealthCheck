...
public static class Helper
{
    ...
    /*
 * GetHtmlListItems: parses an unordered list in HTML and gets a collection of Tuple<string, string>
 *   Unfortunately our SSO does not offere a JSON response, so we just hack up the HTML 
 * In this example it will be:
 *      Tuple 1 item1: "EventConsumerHealthCheck"  item2: "succeeded"
 *      Tuple 2 item1: "Database Connection HealthCheck for SSO succeeded" item2: "Ok"
 *      
    <html>
    <head><title>Health Check Details</title></head>
    <body style="background-color:black;"><h1>Health Check Details</h1>
    <ul>
        <li style="color:green;">EventConsumerHealthCheck succeeded - Succeeded</li>
        <li style="color:green;">Database Connection HealthCheck for SSO succeeded - Ok</li>
    </ul>
    </body>
    </html>
 */
